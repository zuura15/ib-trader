...
class FuzzySignalStrategy:
    """Fuzzy SR fan strategy (Layer 2 testbed). Clone of ChartSignalStrategy
    that we layer RANSAC-respected lines, prominence-scored pivots, and
    parallel-channel detection onto without touching chart_signal."""
